...
func Setup(isCheckTx bool) *Warmage {
	...
	db := dbm.NewMemDB()
	app := NewWarmage(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, 5, encoding.MakeConfig(ModuleBasics), simapp.EmptyAppOptions{})
...
func addTestAddrs(app *Warmage, ctx sdk.Context, accNum int, accAmt sdk.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
...
func initAccountWithCoins(app *Warmage, ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins) {
